...
<html lang="en">
<head>
	<title> create branch panel </title>
	<style>
		*{	
		...
		<div class="container-fluid pt-4 mt-4">
				<div class="row">
					...
					<div class="col-lg-4 card">
						<h2 class="text-center card-header text-dark">Create branch <i class="fas fa-code-branch"></i></h2>
						<form class="card-body" action="branch_valid.php" method="post">
							...
							<div class="form-group">
								...
								<input type="number" class="form-control" name="amount_per_patient">
							</div>
