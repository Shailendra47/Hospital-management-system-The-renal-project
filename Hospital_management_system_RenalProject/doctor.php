		...
		<div class="container-fluid pt-4 mt-4">
				<div class="row">
					...
					<div class="col-lg-4 card">
						<h2 class="text-center card-header text-dark">Doctor Login <i class="fas fa-user-md"></i></h2>
						<form class="card-body" action="patient_graph.php" method="post">
							...
							<button type="submit" class="btn btn-success">Enter <i class="fas fa-key"></i></button>
						</form>
					</div>
