		...
		<div class="container-fluid pt-4 mt-4">
				<div class="row">
					...
					<div class="col-lg-4 card">
						<h2 class="text-center card-header text-dark">Patient registry <i class="fas fa-user-injured"></i></h2>
						<form class="card-body" action="pat_valid.php" method="post">
							...
							<button type="submit" class="btn btn-success">Register <i class="fas fa-plus-circle"></i></button>
						</form>
					</div>
