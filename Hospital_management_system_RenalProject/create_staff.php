...
<html lang="en">
<head>
	<title> create staff panel </title>
	<style>
		*{	
		...
		<div class="container-fluid pt-4 mt-4">
				<div class="row">
					...
					<div class="col-lg-4 card">
						<h2 class="text-center card-header text-dark">Create staff <i class="fas fa-user-tie"></i></h2>
						<form class="card-body" action="sta_valid.php" method="post">
