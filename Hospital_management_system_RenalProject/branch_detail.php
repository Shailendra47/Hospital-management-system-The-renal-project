	...
	<div class="container-fluid" style="
		...
		<div class="container-fluid pb-5" style="height: 577px !important;width: 100%;">
			<div class="col-lg-12 mb-5">
				<br/>
				<h2 class="text-dark text-center mt-2"> Branch Details <i class="fas fa-code-branch"></i></h2>
				...
				<table class="table table-striped table-hover table-bordered text-center" id="myTable">
					...
					<tr class="text-center">
						...
						<td> <?php echo $res['amount_per_patient']; ?> </td>
						<td><button class="btn btn-danger"> <a href="delete_branch.php?id= <?php echo $res['id']; ?>" class="text-white" >Delete</a></button></td>
						<td><button class="btn btn-primary"> <a href="update_branch.php?id=<?php echo $res['id']; ?>" class="text-white"  >Update</a></button></td>
					</tr>
					<?php
						}
					?>	
