	...
	<div class="container-fluid" style="
		...
		<div class="container-fluid pb-5" style="height: 577px !important;width: 100%;">
			<div class="col-lg-12 mb-5">
				<br/>
				<h2 class="text-dark text-center mt-2"> Registered patients <i class="fas fa-user-injured"></i></h2>
				...
				<table class="table table-striped table-hover table-bordered text-center" id="myTable">
					...
					<tr class="text-center">
						...
						<td><button class="btn btn-danger"> <a href="patient_delete.php?id= <?php echo $res['id']; ?>" class="text-white" >Delete</a></button></td>
						<td><button class="btn btn-primary"> <a href="patient_update.php?id=<?php echo $res['id']; ?>" class="text-white"  >Update</a></button></td>
					</tr>
					<?php
						}
					?>	
